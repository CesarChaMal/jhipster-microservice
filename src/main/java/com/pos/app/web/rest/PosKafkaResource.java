package com.pos.app.web.rest;

import com.pos.app.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/pos-kafka")
public class PosKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PosKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public PosKafkaResource(KafkaProperties kafkaProperties) {
